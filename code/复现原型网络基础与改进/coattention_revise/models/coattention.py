...
class AttentionNet(nn.Module):
    ...
    def cca(self, spt, qry):
        ...
        # applying attention
        # print(attn_q.unsqueeze(2))
        # print(type(attn_q.unsqueeze(2)))
        # print(attn_q.unsqueeze(2).shape)
        # print(qry.unsqueeze(1))
        # print(type(qry.unsqueeze(1)))
        # print(qry.unsqueeze(1).shape)
