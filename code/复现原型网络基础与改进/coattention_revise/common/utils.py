...
def parse_args(arg_mode):
    ...
    parser.add_argument('-test_episode', type=int, default=400, help='number of testing episodes after training')

    ''' about SCR '''
    parser.add_argument('-self_method', type=str, default='se')
    ...
    parser.add_argument('-extra_dir', type=str, default='YunshuWang_test', help='extra dir name added to checkpoint dir')
